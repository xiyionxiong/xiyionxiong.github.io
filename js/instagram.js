var Instagram = ( function ()
{
    ...
    var render = function ( data )
    {
        ...
        for ( var em in data )
        {
            ...
            {
                liTmpl += '<span>\
								<div class="img-box" style="margin: 0px 24px 24px 24px">\
            ...
            $( '<section class="archives album"><h1 class="year">' + data[ em ].year + '年<em>' + data[ em ].month + '月</em></h1>\
				<div class="img-box-ul" style="display: flex; flex-wrap:wrap;">' + liTmpl + '</div>\
    ...
    return {
        init: function ()
        {
            ...
            getList( "https://api.instagram.com/v1/users/2723120904/media/recent/?access_token=2723120904.f686a42.3c07a4b996974ae0979318b59a368e19&count=100" );
